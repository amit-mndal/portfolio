  ...
  return (
    <div className="pointer-events-none absolute inset-0 z-[-1]">
      ...
      >
        {isDark ? (
          <>
            <StarsLayer count={4000} radius={1.5} color="#99f6e4" size={0.002} />
            <StarsLayer count={800} radius={1.5} color="#67e8f9" size={0.003} />
          </>
        ) : (
          <>
            <StarsLayer count={3000} radius={1.5} color="#0891b2" size={0.002} />
            <StarsLayer count={600} radius={1.5} color="#0e7490" size={0.003} />
          </>
        )}
      </Canvas>
    </div>
