    ...
    <section className="relative overflow-hidden bg-muted/30 py-12 md:py-24">
      <div className="container mx-auto px-4 text-center md:px-6">
        ...
        >
          ...
          <p className="mx-auto mt-4 max-w-175 text-muted-foreground md:text-xl/relaxed">
             Highlighting my achievements, technical growth & the interests that shape my journey as an engineer.
          </p>
        </motion.div>
